...
/// @title NFT positions
/// @notice Wraps Native V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
  ...
  SelfPermit
{
  // details about the Native position
  struct Position {
  ...
  constructor(
    ...
    ERC721Permit('Native V3 Positions NFT-V1', 'NAT-V3-POS', '1')
