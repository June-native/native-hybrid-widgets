import { PoolApi } from '@native-ammv3/api';
import { Box, Button, LoadingSkeleton } from '@native-ammv3/components';
...
} from '@native-ammv3/dodo-contract-request';
  ...
  return (
    <>
      ...
      >
        <Box>
          <Box>
            {t`Price discrepancy ${lqAndDodoCompareText} between liquidity pool and the quote price on NATIVE.`}
          </Box>
          <Box>
