...
import { TokenPickerDialog } from './Swap/components/TokenCard/TokenPickerDialog';
  ...
  return (
    <>
      ...
      <TokenPickerDialog
        ...
        side={side}
        chainId={chainId}
        occupiedAddrs={occupiedToken ? [occupiedToken.address] : undefined}
        occupiedChainId={occupiedToken?.chainId}
